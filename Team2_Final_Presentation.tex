  ...
  \begin{center}
    \begin{tikzpicture}[
      ...
      box/.style={
        ...
        text width=10.5cm, minimum height=0.6cm,
        align=left, font=\scriptsize
      }
    ]
      \node[box] (s1) {\textbf{1.}\; Data Loading (20 Newsgroups via HuggingFace) $\rightarrow$ Train/Val/Test split};
      ...
      \node[box, below=of s5] (s6) {\textbf{6.}\; OOD Detection (MSP + Temp. Scaling): ID=20 Newsgroups, OOD=AG News};
      \node[box, below=of s6] (s7) {\textbf{7.}\; Evaluate on collected Reddit data, compare \& interpret vs test results};
      \node[box, below=of s7] (s8) {\textbf{8.}\; Confidence score \& certainty of the model (MSP, TTA)};
      ...
      \draw[-{Stealth[length=3mm]}, thick, uniblue] (s6) -- (s7);
      \draw[-{Stealth[length=3mm]}, thick, uniblue] (s7) -- (s8);
    \end{tikzpicture}
  \end{center}
\end{frame}
